...
export function Dashboard({ species }: Props) {
  ...
  // NOVA PALETA PREMIUM (Tons de Esmeralda, Floresta e Água)
  const PIE_COLORS = [
  '#16a34a', // verde forte
  '#22c55e', // verde vivo
  '#84cc16', // lima
  ...
  return (
    <div className="mt-12 mb-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="h-64 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={topSpeciesData} layout="vertical" margin={{ top: 0, right: 10, left: 10, bottom: 0 }}>
                ...
                {/* Cor atualizada para verde bem escuro */}
          ...
          <div className="h-64 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={categoryData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                <Tooltip cursor={{ fill: '#f1f5f9' }} contentStyle={{ borderRadius: '12px', border: 'none', boxShadow: '0 10px 15px -3px rgb(0 0 0 / 0.1)' }} />
                {/* Cor atualizada para Esmeralda principal */}
        ...
        {/* GRÁFICO 3 */}
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
          <h3 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-6 text-center">Por Estado</h3>
          <div className="h-64 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
